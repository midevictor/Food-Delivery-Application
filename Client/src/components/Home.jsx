    ...
    <motion.div className='w-full grid grid-cols-1 md:grid-cols-2 gap-4'>
      <div className='flex flex-col items-start justify-start gap-6'>
        <div className='px-4 py-1 flex items-center justify-center gap-2 bg-orange-100 rounded-full'>
            <p className='text-lg font-semubold text-orange-500'>Freee Delivery</p>
        ...
        <p className='text-textColor text-lg'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nisi vitae in omnis atque. Molestiae tenetur soluta esse minus, voluptatem nostrum, eaque libero, nam cumque animi quisquam? Consequatur maxime quos nulla?
        </p>
