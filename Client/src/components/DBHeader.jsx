...
const DBHeader = () => {
  ...
  return (
    <div className='w-full flex items-center justify-between gap-4'>
        ...
        <div className='flex items-center justify-centr gap-4'>
            <div className='flex items-centr justify-center gap-3 px-4 py-2 bg-lightOverlay backdrop-blur-md rounded-md shadow-md'>
